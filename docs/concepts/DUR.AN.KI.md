...
- **DUR** = Bond, tie, connection
- **AN** = Heaven, the sky
- **KI** = Earth

## Sitchin's Interpretation

> *"DUR.AN.KI was not a metaphor. It was a physical device — a communication beacon that allowed the Anunnaki to maintain contact with their home planet."*
...
Sitchin suggested there were different types of DUR.AN.KI:
- **Communication stations** — For long-range contact with Nibiru
- **Navigation beacons** — For guiding spacecraft
