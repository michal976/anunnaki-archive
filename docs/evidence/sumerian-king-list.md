...
> **Sumerian term:** LU.GAL.LA (𒇽𒃲𒇽𒀭) / PALA (𒉺𒆷) — "Royal Succession"
> **Cuneiform source:** WB-144 Prism (Weld-Blundell Collection, Ashmolean Museum, Oxford)
...
This is not mythology's wildest exaggeration — it is a precise, encoded chronology. Every other ancient civilization remembered an Age of the Gods. Sumer wrote down the exact dates.

The Sumerian King List records eight to ten antediluvian kings reigning a total of 241,200 — or, from a different cylinder, 432,000 — years. Mainstream scholars call these numbers "symbolic" or "mythical." But what if they are not symbolic at all? What if they are the literal tenures of Anunnaki who measured time in Nibiru-years — not Earth-years?
...
The prism stands about 20 cm tall, quadrangular, with cuneiform text inscribed in four columns on each of its four sides. It is written in the Sumerian language and lists the kings of Sumer — from the beginning of kingship before the Flood down to the Isin dynasty (circa 1800 B.C.).
...
It then lists eight kings from five cities — Eridu, Bad-tibira, Larak, Sippar, and Shuruppak — who ruled for a total of **241,200 years** before the Flood.
...
Post-Flood kings, by contrast, have reigns that quickly shrink to normal human lifespans — 1,200 years, 400 years, 30 years, 21 years — implying a fundamental change in the nature of kingship after the Deluge.

### The WB-62 Variant: The 432,000-Year Version

A different copy of the King List — the **WB-62** fragment (also in the Ashmolean) — gives a different total: **432,000 years** for the antediluvian period. This version lists **ten kings** rather than eight, and the reign lengths are reported in **Sumerian SAR** units.
...
| Literal Earth-years | Biologically impossible for human kings — **unless they were not human** |
...
The standard academic view holds that the antediluvian reign lengths are deliberately inflated to emphasize the greatness of the pre-Flood age. Kings who reigned for tens of thousands of years were clearly not real — they were legendary figures.
...
Sumerian mathematics was sexagesimal (base-60). The number 432,000 is 60 × 60 × 120 — a "round" number in their system. Thorkild Jacobsen, the first modern translator of the King List, argued the numbers were symbolic literary devices representing an idealized past.

**Problem:** This explains the number but not why it was chosen specifically to match the antediluvian period — and why it aligns so perfectly with Anunnaki chronology.
...
**Problem:** The Sumerians took their lists very seriously — they updated them for over 1,000 years, and every major city had its own version. These were administrative records, not poems.
...
The Sumerian sign SAR (𒊹), often translated as 3,600, also means "circle" or "cycle" or "complete period." Sitchin identified it as the orbital period of the Twelfth Planet — **Nibiru** — which completes one orbit every 3,600 Earth-years.
...
Thus 120 SAR × 3,600 Earth-years = **432,000 Earth-years** — the total time the Anunnaki were present on Earth before the Flood.

### The Pre-Diluvial Kings Were Anunnaki

Sitchin argued that the antediluvian "kings" were not mortal humans but Anunnaki commanders — chiefs of the expeditions sent from Nibiru to Earth. Each name on the list corresponds to an Anunnaki figure:
...
| En-men-dur-ana | Sippar — Utu/Shamash's city | Center of knowledge |
...
- **Location:** Ashmolean Museum, Oxford — AN1923.444
...
### Genesis 5 — The Biblical Parallel

The Book of Genesis preserves a parallel antediluvian genealogy of ten patriarchs from Adam to Noah, where each lived for many centuries (Adam 930 years, Methuselah 969 years, Noah 950 years). This is the same structural pattern as the King List but scaled down — suggesting the Hebrew scribes translated the Sumerian SAR into human-year equivalents.

### Other King List Copies

At least **18 copies or fragments** of the Sumerian King List are known, including:
- **Kish Tablet** (c. 2000 B.C.) — earliest known fragment
- **Uruk King List** (c. 1800 B.C.) — different city sequence
- **Nippur King List** — variant reign lengths
- **Susa King List** (Elamite adaptation)
- **Lagash King List** (Gudea cylinder)
- **Babylonian King Lists A and B** (later Akkadian versions)

The consistency across all copies — in structure, sequence, and inflated pre-Flood reign lengths — proves this was not a random literary invention but a **canonical record** maintained with great care for over a millennium.
...
|-------|-------------|--------------|-----|
| Anunnaki arrive on Earth | 445,000 B.C. | — | — |
| Establishment of Eridu (first base) | ~445,000 B.C. | — | — |
| Anunnaki kingship begins | ~443,000 B.C. | — | — |
| First Anunnaki settlement period | 445,000 → 432,000 B.C. | 13,000 years | Pre-kingdom phase |
| Antediluvian Anunnaki rule (120 SAR) | ~432,000 → ~13,000 B.C. | 432,000 years | 120 SAR |
| The Great Flood | ~13,000 B.C. | — | — |
| Post-Flood: human kingship begins | ~12,000 B.C. | ~1,000 years | — |
| First Dynasty of Kish (first human king) | ~10,700 B.C. | — | — |
...
The Flood, in this chronology, coincides with the last close passage of Nibiru — whose gravitational effects triggered the Deluge through tidal forces on Earth's ice caps.

---

## The Aha Moment

**The Sumerian King List is not a list of human kings. It is a timetable of Anunnaki occupation — encoded in Nibiru-years.**

| Evidence | What it proves |
|----------|---------------|
| WB-144 and WB-62 prisms — physical clay tablets from 1800 B.C. | The King List is a real ancient document, not modern fiction |
| 432,000 years = 120 SAR × 3,600 | The number is not random — it is based on a precise unit (SAR) |
...
The Sumerian scribes were not inventing myths. They were copying down a chronology they received from a previous age — an age when gods, not men, ruled Sumer. And they measured time not by the sun, but by the orbit of their home planet.
...
| 9 | — | Otiartes (28,800) | Lamech (777 yrs) |
| 10 | Ziusudra (Flood hero) | Xisouthros (18,000) | Noah (950 yrs) |
| **TOTAL** | **241,200–432,000** | **432,000** | **~1,656 yrs** (mortal scale) |

The Sumerian and Berossus totals converge exactly on **432,000 years** (120 SAR). The Biblical version appears to be a scaled-down humanization — converting Nibiru periods into mortal lifespans by reducing the base unit.

---

## See Also

- [Nibiru / The Twelfth Planet — The Anunnaki Homeworld](../evidence/nibiru-twelfth-planet.md)
- [Genetic Creation of Humans — The Atra-Hasis Account](../evidence/genetic-creation-of-humans.md)
- [The Great Flood (Timeline)](../timeline/great-flood.md)
- [WB-144 Prism (Source)](../sources/wb-144-prism.md)
- [Berossus' Babyloniaca (Source)](../sources/berossus-babyloniaca.md)
- [Anunnaki Chronology (Theme)](../themes/anunnaki-chronology.md)
- [SAR — The Sumerian Measure of Time (Concept)](../concepts/sar.md)
- [Eridu (Place)](../places/eridu.md)
- [Ziusudra / Noah (Figure)](../figures/ziusudra.md)
...
- Berossus (3rd century B.C.). *Babyloniaca* — Fragments preserved in Josephus, Eusebius, Syncellus.
- Weld-Blundell Prism (WB-144) — Ashmolean Museum, Oxford. AN1923.444.
- WB-62 Fragment — Ashmolean Museum, Oxford.
- Kramer, Samuel Noah (1963). *The Sumerians: Their History, Culture, and Character*.
- [CDLI — WB-144 Prism](https://cdli.ucla.edu/search/archival_view.php?ObjectID=P438714)
- [CDLI — WB-62 Fragment](https://cdli.ucla.edu/search/archival_view.php?ObjectID=P384771)
