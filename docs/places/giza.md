...
1. **A Navigation Beacon** — Its polished limestone casing made it visible from great distances, serving as a reference point for spacecraft approaching the [Sinai](sinai.md) spaceport
2. **An Astronomical Instrument** — Its shafts align with Orion's Belt (Osiris) and Sirius (Isis), key celestial markers
3. **A Geodetic Marker** — Its location at the exact center of Earth's landmass, aligned to true north within 0.05 degrees
4. **A Power Plant** — Some researchers (though not Sitchin primarily) have suggested the pyramid could generate or focus energy

> *"The Great Pyramid was not a tomb. It was the central beacon of the Anunnaki landing grid — a structure so precisely built that it still stands, measuring the Earth and the heavens."*
...
|-------------|-------|--------------|
| Base perimeter | 36,525.6 inches | 365.256 × 100 (solar year) |
| Height × 43,200 | 3,963.6 miles | Earth's polar radius |
| Base perimeter × 43,200 | 24,734 miles | Earth's equatorial circumference |
