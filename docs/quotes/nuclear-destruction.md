---
tags: [citace, nuclear, destruction, sumer, english]
---

# Nuclear Destruction

Selected quotations from Sumerian lamentations and other texts describing the destruction of [Ur](../places/Ur.md) and [Sippar](../places/Sippar.md), which Zecharia Sitchin interpreted as a nuclear event.
...
> *"The storm that destroys everything came from the horizon — an evil wind, a storm that knows no mercy."*

> *"Like the burning of a great torch, the fire consumed the city. The people were as if turned to stone."*

## The "Evil Wind"

> *"The evil wind, the terrible storm, came upon the land. The cities were destroyed in a single day. The rivers ran with poison. The fields were burned."* — Sumerian text
...
## Biblical Parallel — Sodom and Gomorrah
...
- [Nuclear Destruction](nuclear-destruction.md) — The event in Concepts
- [Nuclear Weapons](../themes/nuclear-weapons.md) — The weapons
