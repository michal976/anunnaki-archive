...
The epic describes a primordial cosmic struggle between two primeval entities: [Tiamat](../characters/Tiamat-Kingu.md) (the saltwater ocean, personified as a dragon-goddess) and [Apsu](../places/Apsu.md) (the freshwater ocean). When the younger gods disturb the cosmic order with their activity, Apsu plots to destroy them, but is killed by [Ea/Enki](../characters/Enki.md). Tiamat, enraged, creates an army of eleven monsters led by her consort Kingu, and wages war against the gods.

The younger gods rally behind [Marduk](../characters/Marduk.md), who defeats Tiamat by splitting her body in two — creating the heavens (one half) and the Earth (the other half). From Kingu's blood, Marduk creates humanity to serve the gods.

## Sitchin's Interpretation

Sitchin radically reinterpreted this text as a *celestial* rather than *mythological* account:

> *"The Enuma Elish is not a myth. It is a scientifically accurate account of the creation of our solar system, encoded in the language of myth."* — Zecharia Sitchin, *The 12th Planet*

**His reading included the following revisions:**

1. **Tiamat** is not a goddess but a primordial planet that existed between Mars and Jupiter
2. **Apsu** is the Sun
3. **Mummu** (mentioned in the text) is Mercury
4. **Lahmu and Lahamu** are Mars and Venus
5. **Anshar and Kishar** are Saturn and Jupiter
6. **Anu** is Uranus
7. **Ea/Nudimmud** is Neptune
8. **Marduk** is [Nibiru](../characters/Nibiru.md), the invading planet from outer space
9. **Kingu** is a moon of Tiamat that became the asteroid belt
...
- A theological document legitimizing [Marduk](../characters/Marduk.md) as the supreme god of Babylon
...
Scholars such as [Lambert](../criticism/Lambert.md) and [Heiser](../criticism/Heiser.md) have pointed out that Sitchin's translations often depart significantly from standard Sumerological consensus.
...
| VI | Creation of humanity | Genetic engineering of [Adamu](../concepts/Adamu.md) |
| VII | Hymns to Marduk | Marduk's fifty names |

## See Also

- [Twelfth Planet](twelfth-planet.md) — Sitchin's book expanding this interpretation
- [Tiamat Kingu](../characters/Tiamat-Kingu.md) — The celestial interpretation
