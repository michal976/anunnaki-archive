...
1. **The Spaceport** — The Anunnaki landing site in the Sinai
2. **The Great Pyramid** — The Giza pyramid as a navigation beacon
3. **Baalbek** — The megalithic platform as a launch pad
4. **The Landing Corridor** — The alignment of sites from Baalbek to Sinai
5. **The Sphinx** — The guardian of the spaceport
6. **Gilgamesh and the Quest for Immortality** — The Sumerian king's journey to the spaceport

## The Sinai Spaceport

Sitchin identifies the central Sinai plateau — specifically the area around the mountain known to the Egyptians as the "Stairway of the Gods" — as the primary spaceport of the Anunnaki. The two main landing corridors were aligned with prominent peaks:
...
This "ladder" or "stairway" was the rocketship ([SHEM](../concepts/SHEM.md)) platform at the Jerusalem temple mount — the "Mount of the Crossing" (Moriyah).

## The Giza Connection

Sitchin argues that the [Great Pyramid](../places/giza.md) was not a tomb but an advanced navigational instrument:
...
The book includes a detailed analysis of the [Epic of Gilgamesh](../characters/gilgamesh.md), which Sitchin reads as a historical account of a Sumerian king's journey to the Anunnaki spaceport in search of the secret of immortality. Gilgamesh travels to the [Tilmun](../places/Tilmun.md) (the "land of the rocketships") and meets Utnapishtim (the Sumerian Noah), who tells him the story of the flood.

### Baalbek

The massive stone platform at [Baalbek](../places/Baalbek.md) in Lebanon, with stones weighing up to 1,200 tons, is identified by Sitchin as the original launch pad for Anunnaki rocketships. No known ancient technology could have moved stones of this size.

## See Also

- [SHEM](../concepts/SHEM.md) — The rocketship terminology
- [Sinai Spaceport](../concepts/sinai-spaceport.md) — The Sinai spaceport
- [Giza](../places/giza.md) — The Great Pyramid
- [Baalbek](../places/Baalbek.md) — The megalithic platform
- [Tilmun](../places/Tilmun.md) — The land of the rockets
- [Gilgamesh](../characters/gilgamesh.md) — The Sumerian king
