...
> **Sumerian name:** ITI (𒌗) — "Month" / MU (𒈬) — "Year"
...
- **1 Nibiru year** = 3,600 Earth years ([NÉRU](../concepts/neru.md))
...
The Sumerian calendar year of 360 days (12 × 30) was, Sitchin argued, not based on the solar year (365.25 days) but on a celestial cycle. The number 360 appears repeatedly in:
...
Sitchin gave special attention to the zodiac, which he argued the Anunnaki divided into 12 houses. Each house corresponds to 30° of the celestial path and approximately 2,160 years of the precessional cycle:
...
- [Precession](precession.md) — The precessional cycle
...
- [Nannar](../characters/Nannar.md) — The moon god, timekeeper
