...
> **Sumerian name:** LULLU (𒇽𒇽) — "Primitive Worker"
...
According to the [Atra Hasis](../sources/Atra-Hasis.md) epic, the gods created humanity from clay mixed with the "flesh and blood" of a slain deity:
...
The being created was called the *Lullu* ("primitive worker") — a hybrid designed to perform the heavy labor that the [Igigi](../concepts/Igigi.md) had been forced to do.

## The "Missing Link"

Sitchin connected his narrative to the paleontological record:

> *"The sudden appearance of Homo sapiens approximately 300,000 years ago, with a brain capacity and cognitive abilities far beyond any preceding hominid, is exactly what one would expect from an external intervention — not from gradual evolution."*

He pointed to:
- The "missing link" between Homo erectus and Homo sapiens
- The sudden explosion of human cognitive capacity (the "Great Leap Forward")
- The mitochondrial "Eve" dating to approximately 200,000 years ago
- The relative youth of the human genome compared to other species
...
| Participant | Role |
|-------------|------|
| [Enki](../characters/Enki.md) | Project leader, proposed the idea |
| [Ninmah](../characters/Ninmah.md) (Nintur) | Chief geneticist, performed the laboratory work |
| [Utu](../characters/Utu.md) | Possibly involved in the oversight |

## The Failed Experiments

The "Debate between Enki and Ninmah" describes the creation of various imperfect humans — the blind, the lame, the sterile. Sitchin read this as a record of failed early experiments before the successful creation of viable Homo sapiens.
...
- [Adamu](../concepts/Adamu.md) — The first genetically engineered human
- [Adapa](../concepts/Adapa.md) — The sage, a perfected human
- [Creation Of Humans](../timeline/creation-of-humans.md) — The creation account in the timeline
