...
| Number | Significance |
|--------|-------------|
| 60 | Highest sacred number of [Anu](../characters/Anu.md) |
| 50 | Sacred number of [Enlil](../characters/Enlil.md) |
| 40 | Sacred number of [Enki](../characters/Enki.md) |
| 30 | Sacred number of [Nannar](../characters/Nannar.md) |
| 20 | Sacred number of [Utu](../characters/Utu.md) |
| 15 | Sacred number of [Inanna](../characters/Inanna.md) |
| 12 | Anunnaki council, zodiac signs, months |
| 7 | Visible celestial bodies, days of the week |
| 3,600 | [NÉRU](../concepts/neru.md) — one Nibiru orbit |
| 2,160 | 1/12 of precessional cycle (one zodiac age) |
| 25,920 | Full precessional cycle |
| 432,000 | Number in Sumerian King List (12 × 36,000) |
...
- The base of the pyramid is 440 cubits (11 × 40)
...
Sitchin argued that 12 was derived from the 12 celestial bodies in the Sumerian solar system (Sun, Moon, and 10 planets including [Nibiru](../characters/Nibiru.md)).
